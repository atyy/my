...
<template>
    ...
    <gw-header></gw-header>
      ...
      <div class="reports-3-content" v-if="info">
        ...
        <!-- 模块消息-->
        <div class="solution">
          <collapses custom name="运动训练方法" :typeStyle="typeStyle" v-if="info.report['CN'].method_of_training">
            <div class="sub_wrap">
              
              <div class="txt" v-html="info.report['CN'].method_of_training"></div>

            </div>
          </collapses>

          <collapses custom name="训练注意事项" :typeStyle="typeStyle" v-if="info.report['CN'].cautions_of_training">
            <div class="sub_wrap">
              
              <div class="txt" v-html="info.report['CN'].cautions_of_training"></div>
